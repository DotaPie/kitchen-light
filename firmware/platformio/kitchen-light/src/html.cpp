...
<html>
<head>
	<title>Kitchen light setup</title>
</head>
<body>
	<h1>Setup kitchen light</h1>
	...
	<form action="/action_page.php">
		...
		(example: UK)<br>
		<input type="text" id="country-code" name="country-code"><br><br>
		
		<label for="gmt"><b>TIME ZONE</b></label><br>
...
const char *htmlWebPageCompleteFormatter = R"======(
<!DOCTYPE html>
<html>
<head>
	<title>Kitchen light setup</title>
